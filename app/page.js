...
export default function Home() {
  return (
    <main className="min-h-[90vh] flex flex-col-reverse md:flex-row items-center justify-center px-6 gap-16">
      ...
      >
        ...
        >
          <Link
            href="/projects"
            className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-blue-500/50 transition transform hover:-translate-y-1"
          >
            View Projects
          </Link>
          <Link
            href="/contact"
            className="px-6 py-3 border border-white text-white hover:bg-white hover:text-black font-semibold rounded-lg transition transform hover:-translate-y-1"
          >
            Contact Me
          </Link>
        </motion.div>
